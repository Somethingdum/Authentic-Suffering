...
INFO-07 seed(tx, holder_id, about_id, claim, at, turn_index, cause_event_id, confidence=3) -> str
  ...
  sentence = claim_sentence(claim, word_for(tx, holder, about_id)).
...
def seed(tx: "Tx", holder_id: str, about_id: str, claim: str, at: int, turn_index: int,
         cause_event_id: str | None, confidence: int = 3) -> str:
