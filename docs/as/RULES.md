...
| CHEAT-05 | Quarantined entities are excluded from worldgen/threat/faction/economy maths and the abuse battery | CHEATS §9 | `as_engine/cheats/__init__.py`, `as_engine/cheats/commands.py`, `as_content/packs/cheat_admin/actors/fredrick.yaml` | `contract/p12_surfaces/test_cheat_console.py`, `contract/p12_surfaces/test_cheat_owner.py`, `contract/p12_surfaces/test_cheat_twin.py` |
