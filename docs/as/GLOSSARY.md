...
| stress | how worn down a person is, 0–10 (`actors.stress`): deaths seen, hunger, blows, threats; eased by sleep (CAS-019..021). It shortens the fuse. (Not the wet strain, not a door's strain.) | how close to breaking they are | — |
| temper | how a person breaks: fuse 1–5, outlet (fists, words, cold, flight, tears), grudge 0–3, pet peeves, what settles them (`contracts.dossier.Temper`; TEMPER-01) | what sets them off | — |
| heat | one person's anger at another right now, 0–20 (`tempers`); builds from provocations, fades an hour at a time, kept warm by a grudge (TEMPER-02) | how angry they are with someone | — |
...
| plain-words cheat | a sentence in the Cheat field that the console turns into steps (CHEAT-16, CHEAT-17) | — | natural-language command |
