...
3. **P12** — the surfaces (§5). The cheat console of CHEATS.md is BUILT (D-100; tests 12 §3.18), and
   ...
   build the P8 plugin), and so is the death screen with Willis at every death (D-105: the cause as
   the dead felt it, their choices, Willis roasting them from their own record, the truth only on
   the button); still to do: a new life here and the rest below. The owner's list was: overwriting an
